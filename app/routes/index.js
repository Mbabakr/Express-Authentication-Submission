...
router.get('/', function(req, res) {
    var global_data={
        "page_title":"Mohammed Ba Bakr - Web Developer"
    };
...
router.get('/services', function(req, res) {
    var global_data={
        "page_title":"Mohammed Ba Bakr - Services"
    };
...
router.get('/projects', function(req, res) {
    var global_data={
        "page_title":"Mohammed Ba Bakr - Projects"
    };
...
router.get('/aboutme', function(req, res) {
    var global_data={
        "page_title":"Mohammed Ba Bakr - About Me"
    };
...
router.get('/contact', function(req, res) {
    var global_data={
        "page_title":"Mohammed Ba Bakr - Contact"
    };
...
router.get('/update/:id', authCheck,function(req, res) {
    var global_data={
        "page_title":"Mohammed Ba Bakr - Update Contact"
    };
...
router.get('/admin', authCheck, function(req, res) {
    ...
    MongoClient.connect(mongoUrl, function(err,db){
        ...
        dbo.collection("contact_list").find().toArray(function(err,results){
            ...
            var global_data={
                "page_title":"Mohammed Ba Bakr - Manage Contacts",
...
router.get('/login', function(req, res) {
    ...
    var global_data={
        ...
        "page_title":"Mohammed Ba Bakr - Login"
    };
